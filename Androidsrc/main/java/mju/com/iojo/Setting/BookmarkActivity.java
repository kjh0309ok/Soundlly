...
public class BookmarkActivity extends AppCompatActivity implements OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        readJson.execute("http://192.168.100.121/Get/GetBookmark.php");
    ...
    public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
        ...
        DialogInterface.OnClickListener deleteListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                delete.execute("http://192.168.100.121/Delete/DeleteBookmark.php?top="+deleteTop+"&bottom="+deleteBottom);
                System.out.println("http://192.168.100.121/Delete/DeleteBookmark.php?top="+deleteTop+"&bottom="+deleteBottom);
