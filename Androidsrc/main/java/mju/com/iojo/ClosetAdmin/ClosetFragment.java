...
public class ClosetFragment extends Fragment implements OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        readJson.execute("http://192.168.100.121/Get/GetStyle.php?type="+type+"&style="+style);
        deleteType = type;
    ...
    public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
        ...
        DialogInterface.OnClickListener deleteListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                delete.execute("http://192.168.100.121/Delete/DeleteStyle.php?type="+deleteType+"&uri="+deleteUri);
