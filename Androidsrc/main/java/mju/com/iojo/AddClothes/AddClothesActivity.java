            ...
            protected String doInBackground(String... params) {
                try{
                    ...
                    if(type.equals("outer")){
                        link="http://192.168.100.121/Insert/InsertOuterStyle.php";
                    } else if (type.equals("top")){
                        link="http://192.168.100.121/Insert/InsertTopStyle.php";
                    } else if (type.equals("bottom")){
                        link="http://192.168.100.121/Insert/InsertBottomStyle.php";
                    }
